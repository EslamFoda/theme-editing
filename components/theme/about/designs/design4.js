...
const Design4 = ({ choose = false, handleEdit, aboutData,backgroundColor }) => {
  return (
    <>
      {choose ? (
        <div>
        ...
        <div style={{  backgroundColor: `rgba(${backgroundColor?.r}, ${backgroundColor?.g}, ${backgroundColor?.b}, ${backgroundColor?.a})`,}} className="py-14">
          <Container>
            <div
              className={
